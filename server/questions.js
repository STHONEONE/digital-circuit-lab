...
export const seedQuestions = [
  {
    ...
    title: "二进制加法与十进制转换",
    type: "single_choice",
    text: "计算 (101101)₂ + (0110)₂，并把结果转换为十进制数，结果是多少？",
    options: ["47", "49", "51", "53"],
    answer: 2,
    answerText: "51",
    explanation: "101101B=45，0110B=6，两者相加为 51。",
  ...
  },
  {
    ...
    title: "十六进制与二进制关系",
    type: "single_choice",
    text: "十六进制数 2F 与二进制数 0010 1111 表示同一个数。若该数再加 1，十六进制结果是多少？",
    options: ["2E", "30", "3F", "20"],
    answer: 1,
    answerText: "30",
    explanation: "2F(H)+1=30(H)，对应二进制从 0010 1111 进位为 0011 0000。",
  ...
  },
  {
    ...
    title: "优先编码器输出判断",
    type: "single_choice",
    text: "8 线-3 线优先编码器中，I7 优先级最高、I0 最低。若 I5 与 I2 同时有效，输出二进制编码应是多少？",
    options: ["101", "100", "011", "110"],
    answer: 0,
    answerText: "101",
    explanation: "优先编码器输出最高优先级有效输入的编号。I5 的优先级高于 I2，因此输出 101。",
  ...
  },
  {
    ...
    title: "3-8 译码器使能输出",
    type: "single_choice",
    text: "高电平有效的 3-8 译码器在使能端有效时，输入 ABC=110；若使能端无效，所有输出均为 0。当前使能有效时哪一路输出为 1？",
    diagramSvg: decoderSvg,
    explanationSvg: decoderSvg,
    options: ["Y5", "Y6", "Y7", "Y3"],
    answer: 1,
    answerText: "Y6",
    explanation: "使能有效时译码器才工作。ABC=110 对应十进制 6，因此 Y6 输出为 1。",
    knowledge: ["译码器", "组合逻辑"],
    keywords: [],
    difficulty: 2
  },
  ...
  },
  {
    ...
    title: "SR 触发器状态推演",
    type: "single_choice",
    text: "SR 触发器初态 Q=0，连续三个有效控制状态依次为 S,R=10、00、01。最后 Q 的状态是多少？",
    options: ["0", "1", "保持为初态", "禁止状态"],
    answer: 0,
    answerText: "0",
    explanation: "10 使 Q 置 1，00 保持为 1，01 复位为 0，所以最后 Q=0。",
  ...
  },
  {
    ...
    title: "二进制计数器状态推演",
    type: "single_choice",
    text: "3 位二进制加法计数器当前状态为 011，经过 5 个有效计数脉冲后状态变为多少？",
    diagramSvg: counterSvg,
    explanationSvg: counterSvg,
    options: ["000", "001", "111", "100"],
    answer: 0,
    answerText: "000",
    explanation: "011 表示 3，经过 5 个加法脉冲为 8；3 位计数器按模 8 回卷，因此状态为 000。",
